	...
	// css-class start
		if ($(window).width() <= 412) {
			...
			$(".myprojects").removeClass("text-h3").addClass("text-h4").css("text-align","center");
			...
			$(".myprojects").addClass("text-h3").removeClass("text-h4").css("text-align","center");
